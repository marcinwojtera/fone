      ...
      <div>
        ...
        <div className="race-timming">
          <div className="race-timming-sticky">
            ...
            {map(this.props.seasonQualify, z => (this.state.driversListToShow.indexOf(z.Driver.driverId) >= 0 ? (<div className="race-driver" key={z.Driver.code}>{z.Driver.code}</div>) : null))}
          </div>
          <PerfectScrollbar>
...
Lap
              ...
              {map(this.props.seasonQualify, (z, d) => (this.state.driversListToShow.indexOf(z.Driver.driverId) >= 0 ? (
